...
def get_account_transactions(account_id):
    ...
    filtered = [tx for tx in TRANSACTIONS if tx["from"] == account_id or tx["to"] == account_id]
    return jsonify({"transactions": filtered, "count": len(filtered), "account_id": account_id}), 200
